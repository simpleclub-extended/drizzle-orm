...
> extends TypedQueryBuilder<TSelectedFields, TResult> {
	 ...
	 *   );
	 * // or
	 * import { union } from 'drizzle-orm/google-sql-core'
	 *
	 * await union(
	 ...
	 *   );
	 * // or
	 * import { unionAll } from 'drizzle-orm/google-sql-core'
	 *
	 * await unionAll(
	 ...
	 *   );
	 * // or
	 * import { intersect } from 'drizzle-orm/google-sql-core'
	 *
	 * await intersect(
	 ...
	 * );
	 * // or
	 * import { intersectAll } from 'drizzle-orm/google-sql-core'
	 *
	 * await intersectAll(
	 *   db.select({
	 *     productId: regularCustomerOrders.productId,
	 ...
	 *   );
	 * // or
	 * import { except } from 'drizzle-orm/google-sql-core'
	 *
	 * await except(
	 *   db.select({ courseName: depA.courseName }).from(depA),
	 *   db.select({ courseName: depB.courseName }).from(depB)
	 ...
	 * );
	 * // or
	 * import { exceptAll } from 'drizzle-orm/google-sql-core'
	 *
	 * await exceptAll(
	 *   db.select({
	 *     productId: regularCustomerOrders.productId,
	 ...
	 *
	 * Calling this method will specify a lock on the affected cells for the duration of the transaction.
	 *
	 * See docs: {@link https://docs.cloud.google.com/spanner/docs/reference/standard-sql/query-syntax?hl=en#for_update_clause | Google Cloud Spanner query syntax}
	 *
