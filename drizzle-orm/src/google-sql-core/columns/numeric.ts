...
export class GoogleSqlNumericBuilder<T extends ColumnBuilderBaseConfig<'number', 'GoogleSqlNumeric'>>
...
export class GoogleSqlNumeric<T extends ColumnBaseConfig<'number', 'GoogleSqlNumeric'>> extends GoogleSqlColumn<T> {
